    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Category", "CostPrice", "Name", "QuantityInStock", "SellingPrice" },
                values: new object[,]
                {
                    { 1, "Cement", 300m, "Portland Cement", 100, 400m },
                    { 2, "Steel Rods", 50m, "Steel Rod (10mm)", 200, 70m }
                });
